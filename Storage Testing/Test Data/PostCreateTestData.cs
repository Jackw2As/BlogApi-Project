...
public class PostCreateTestData : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[] { new CreatePost("Good Title", Faker.Lorem.Sentence(256), "")};

        //Summary Minimum Length 1
        yield return new object[] { new CreatePost("Good Title", "", "") };

        //Content can't be null
        yield return new object[] { new CreatePost("Good Title", null, "") };

        //Content Max Length 5000
        yield return new object[] { new CreatePost("Good Title", Faker.Lorem.Sentence(5001), "") };
    }
